...
class Connection{
    ...
    dbConfig(){
        ...
        connection.Task = require('../models/Task')(connection.init, DataTypes)
        connection.TodoList = require('../models/TodoList')(connection.init, DataTypes)
        connection.Task_Assigned= require('../models/Task_Assigned')(connection.init, DataTypes)
        
        //asociar los modelos
        connection.User.associate(connection)
        connection.Task.associate(connection)
        connection.TodoList.associate(connection)
        connection.Task_Assigned.associate(connection)
